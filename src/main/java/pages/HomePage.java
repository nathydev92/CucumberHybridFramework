...
public class HomePage {
    ...
    public HomePage(WebDriver driver){
         //All page factory will be initialize
         this.driver = driver;
    ...
    public void clickOnMyAccount(){
        ...
        elementUtils.clickOnElement(myAccountDropMenu, CommonUtils.PAGE_LOAD_TIME);
    ...
    public void enterProductToSearchBox(String productText){
